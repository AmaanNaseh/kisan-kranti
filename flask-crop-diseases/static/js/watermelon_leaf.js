...
const changePreviewImage = () => {
  var allPreviewImages = [
    "../static/assets/leaf/dataset/watermelon/watermelon_healthy.jpg",
    "../static/assets/leaf/dataset/watermelon/watermelon_downey_mildew.jpg",
    "../static/assets/leaf/dataset/watermelon/watermelon_mosaic_virus.jpg",
  ];
...
async function handleSubmit(event) {
  ...
  try {
    res = await fetch("/leaf/watermelon", {
      method: "POST",
      body: formData,
    });
    data = await res.text();
