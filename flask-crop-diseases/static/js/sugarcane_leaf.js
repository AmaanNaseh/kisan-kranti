...
const changePreviewImage = () => {
  var allPreviewImages = [
    "../static/assets/leaf/dataset/sugarcane/sugarcane_healthy.jpg",
    "../static/assets/leaf/dataset/sugarcane/sugarcane_bacterial_blight.jpg",
    "../static/assets/leaf/dataset/sugarcane/sugarcane_mosaic_virus.jpg",
    "../static/assets/leaf/dataset/sugarcane/sugarcane_red_rot.jpg",
    "../static/assets/leaf/dataset/sugarcane/sugarcane_rust.jpg",
    "../static/assets/leaf/dataset/sugarcane/sugarcane_yellow_rot.jpg",
  ];
...
async function handleSubmit(event) {
  ...
  try {
    res = await fetch("/leaf/sugarcane", {
      method: "POST",
      body: formData,
    });
    data = await res.text();
