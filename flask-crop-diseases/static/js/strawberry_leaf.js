...
const changePreviewImage = () => {
  var allPreviewImages = [
    "../static/assets/leaf/dataset/strawberry/strawberry_healthy.jpg",
    "../static/assets/leaf/dataset/strawberry/strawberry_leaf_scorch.jpg",
  ];
...
async function handleSubmit(event) {
  ...
  try {
    res = await fetch("/leaf/strawberry", {
      method: "POST",
      body: formData,
    });
    data = await res.text();
