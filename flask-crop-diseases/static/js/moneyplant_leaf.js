...
const changePreviewImage = () => {
  var allPreviewImages = [
    "../static/assets/leaf/dataset/moneyplant/moneyplant_healthy.jpg",
    "../static/assets/leaf/dataset/moneyplant/moneyplant_bacterial_wilt.jpg",
    "../static/assets/leaf/dataset/moneyplant/moneyplant_manganese_toxicity.jpg",
  ];
...
async function handleSubmit(event) {
  ...
  try {
    res = await fetch("/leaf/moneyplant", {
      method: "POST",
      body: formData,
    });
    data = await res.text();
