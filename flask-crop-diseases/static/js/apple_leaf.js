...
const changePreviewImage = () => {
  var allPreviewImages = [
    "../static/assets/leaf/dataset/apple/apple_healthy.jpg",
    "../static/assets/leaf/dataset/apple/apple_black_rot.jpg",
    "../static/assets/leaf/dataset/apple/apple_cedar_rust.jpg",
    "../static/assets/leaf/dataset/apple/apple_scab.jpg",
  ];
